...
Данный проект представляет собой Telegram бота с интеграцией LLM, разработанного с применением принципа KISS и функционального подхода. В текущей версии (v0.2.0) бот умеет отвечать на любые вопросы пользователей с помощью искусственного интеллекта.
